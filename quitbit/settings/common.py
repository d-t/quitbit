...
SECRET_KEY = r"_ety!7c=#ita_=&75%v0-l^fu@*43z&7$lwfy*$n06e5ikxq=y"
...
########## ACCOUNT AND LOGIN
AUTH_USER_MODEL = 'qb_account.QuitBitUser'

USER_EMAIL_CONFIRMATION = False
USER_REQUIRED_FIELDS = [] # add fields here to make them mandatory during registration

LOGIN_REDIRECT_URL = '/api/'

##########  END ACCOUNT AND LOGIN



##########  APPS SPCECIFIC SETTINGS
